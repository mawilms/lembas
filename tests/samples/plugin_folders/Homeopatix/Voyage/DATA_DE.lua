...
houseLocationsMap = {
    house1 = {mapHex = 0x410d9a54, texte = "Seidlung BreeLand"},
    house2 = {mapHex = 0x410d9934, texte = "Seidlung Falathlorn"},
    house3 = {mapHex = 0x410d9a56, texte = "Seidlung Thorins halle"},
    house4 = {mapHex = 0x410d9a57, texte = "Seidlung AuenLand"},
    house5 = {mapHex = 0x411ee217, texte = "Seidlung Ostfold-H\195\188gel"},
    house6 = {mapHex = 0x411ee218, texte = "Seidlung K\195\182nigsstattweiden"},
    house7 = {mapHex = 0x411aef52, texte = "Seidlung kaps von Belfalas"}
    };
------------------------------------------------------------------------------------------
-- DATA racial
------------------------------------------------------------------------------------------
...
racialLocationsMap = {
        racial1 = {mapHex = 0x41008136, texte = "R\195\160ckkehr nach Bree", coordx = "470", coordy = "500"},
        racial2 = {mapHex =  0x41008137, texte = "R\195\160ckkehr ins Auenland", coordx = "270", coordy = "525"},
        racial3 = {mapHex =  0x4100812B, texte = "R\195\160ckkehr zu Thorins Tor", coordx = "450", coordy = "320"},
        racial4 = {mapHex =  0x4100812D, texte = "R\195\160ckkehr nach Bruchtal", coordx = "520", coordy = "420"},
        racial5 = {mapHex =  0x4115B98B, texte = "Zum 1. Heim zur\195\160ckkehren", coordx = "640", coordy = "400"},
        racial6 = {mapHex =  0x410E8706, texte = "Reise nach Caras Galadhon in Lothl\195\179rien", coordx = "370", coordy = "520"},
        racial7 = {mapHex =  0x4100812B, texte = "Reise zu Thorins Halle", coordx = "450", coordy = "320"}
        };
------------------------------------------------------------------------------------------
-- DATA chasseur
------------------------------------------------------------------------------------------
...
hunterLocationsMap = { 
    hunter1 = {mapHex = 0x41008139, texte = "Zur\195\160ck zum Lager", coordx = "0", coordy = "0"},
    hunter2 = {mapHex = 0x41008136, texte = "F\195\160hrer nach Bree", coordx = "470", coordy = "500"},
    hunter3 = {mapHex = 0x4100812B, texte = "F\195\160hrer zu Thorins Halle", coordx = "450", coordy = "320"},
    hunter4 = {mapHex = 0x41008137, texte = "F\195\160hrer nach Michelbinge", coordx = "270", coordy = "525"},
    hunter5 = {mapHex = 0x41008132, texte = "F\195\160hrer nach Esteld\195\173n", coordx = "650", coordy = "320"},
    hunter6 = {mapHex = 0x4101f084, texte = "F\195\160hrer nach Evendim", coordx = "510", coordy = "750"},
    hunter7 = {mapHex = 0x41008130, texte = "F\195\160hrer zur Feste Guruth", coordx = "630", coordy = "245"},
    hunter8 = {mapHex = 0x4100812D, texte = "F\195\160hrer nach Bruchtal", coordx = "520", coordy = "420"},
    hunter9 = {mapHex = 0x410e3f46, texte = "F\195\160hrer nach S\195\187ri-kyl\195\164", coordx = "540", coordy = "160"},
    hunter10 = {mapHex = 0x41008131, texte = "F\195\160hrer in das westliche Angmar", coordx = "100", coordy = "520"},
    hunter11 = {mapHex = 0x41008131, texte = "F\195\160hrer nach Ost-Angmar", coordx = "650", coordy = "160"},
    hunter12 = {mapHex = 0x410e8686, texte = "F\195\160hrer nach Echad D\195\186nann", coordx = "540", coordy = "530"},
    hunter13 = {mapHex = 0x410e871b, texte = "F\195\160hrer zur Einundzwanzigsten Halle", coordx = "670", coordy = "180"},
    hunter14 = {mapHex = 0x41100DF2, texte = "F\195\160hrer zur Dunkelsenke", coordx = "100", coordy = "450"},
    hunter15 = {mapHex = 0x411ad8a9, texte = "F\195\160hrer nach Harndirion", coordx = "460", coordy = "530"},
    hunter16 = {mapHex = 0x41116EFE, texte = "F\195\160hrer nach Galtrev", coordx = "450", coordy = "360"},
    hunter17 = {mapHex = 0x41123F09, texte = "F\195\160hrer nach Stangard", coordx = "440", coordy = "510"},
    hunter18 = {mapHex = 0x410E8706, texte = "F\195\160hrer nach Caras Galadhon", coordx = "370", coordy = "520"},
    hunter19 = {mapHex = 0x4100812f, texte = "F\195\160hrer ins Nebelgebirge", coordx = "760", coordy = "420"},
    hunter20 = {mapHex = 0x41132E57, texte = "F\195\160hrer nach Schneegrenze", coordx = "425", coordy = "430"},
    hunter21 = {mapHex = 0x411379FF, texte = "F\195\160hrer nach Forlach", coordx = "530", coordy = "700"},
    hunter22 = {mapHex = 0x4113C321, texte = "F\195\160hrer nach Aldburg", coordx = "315", coordy = "410"},
    hunter23 = {mapHex = 0x4113C323, texte = "F\195\160hrer nach Helms Klamm", coordx = "445", coordy = "430"},
    hunter24 = {mapHex = 0x41154e05, texte = "F\195\160hrer nach Dol Amroth", coordx = "460", coordy = "340"},
    hunter25 = {mapHex = 0x4115ee3c, texte = "F\195\160hrer nach Arnach", coordx = "535", coordy = "435"},
    hunter26 = {mapHex = 0x411656ef, texte = "F\195\160hrer nach Minas Tirith", coordx = "860", coordy = "410"},
    hunter27 = {mapHex = 0x4113C31F, texte = "F\195\160hrer zum Kriegslager der Rohirrim", coordx = "460", coordy = "620"},
    hunter28 = {mapHex = 0x4119389d, texte = "F\195\160hrer zum schlachtgezeichneten Minas Tirith", coordx = "860", coordy = "410"},
    hunter29 = {mapHex = 0x411a42e7, texte = "F\195\160hrer zu Henneth Ann\195\187n", coordx = "600", coordy = "250"},
    hunter30 = {mapHex = 0x411a42e5, texte = "F\195\160hrer zum schlachtgezeichneten Osgiliath", coordx = "650", coordy = "280"},
    hunter31 = {mapHex = 0x411ad8a9, texte = "F\195\160hrer zum Lager des Heeres", coordx = "600", coordy = "250"},
    hunter32 = {mapHex = 0x411ad8a9, texte = "F\195\160hrer nach Haerondir", coordx = "430", coordy = "540"},
    hunter33 = {mapHex = 0x411b9591, texte = "F\195\160hrer zum Ud\195\187n-Br\195\160ckenkopf", coordx = "140", coordy = "150"},
    hunter34 = {mapHex = 0x411c2de2, texte = "F\195\160hrer nach Thal", coordx = "750", coordy = "340"},
    hunter35 = {mapHex = 0x411cd4b8, texte = "F\195\160hrer nach J\195\161rnfast", coordx = "910", coordy = "260"},
    hunter36 = {mapHex = 0x411c8da9, texte = "F\195\160hrer nach Skarh\195\161ld", coordx = "450", coordy = "460"},
    hunter37 = {mapHex = 0x4115B98B, texte = "F\195\160hrer nach Beorningerh\195\186s", coordx = "640", coordy = "400"},
    hunter38 = {mapHex = 0x411da4a0, texte = "Leitfaden f\195\160r Hultv\195\173s", coordx = "670", coordy = "350"},
    hunter39 = {mapHex = 0x411e9a41, texte = "F\195\160hrer nach Estolad L\195\162n", coordx = "610", coordy = "320"},
    hunter40 = {mapHex = 0x411ee769, texte = "F\195\160hrer nach Liml\195\179k", coordx = "730", coordy = "560"},
    hunter41 = {mapHex = 0x411fb86f, texte = "F\195\160hrer nach Ann\195\162k-khurfu", coordx = "720", coordy = "720"},
    hunter42 = {mapHex = 0x4101f084, texte = "F\195\160hrer zum H\195\164ndlerkai", coordx = "720", coordy = "680"}, -- new from Update U29
    hunter43 = {mapHex = 0x41008132, texte = "F\195\160hrer nach Schragen", coordx = "240", coordy = "640"},
    hunter44 = {mapHex = 0x4120d01b, texte = "F\195\160hrer nach Akr\195\162z-zahar", coordx = "580", coordy = "680"},-- new from U30
    hunter45 = {mapHex = 0x4120d01b, texte = "F\195\160hrer nach Azanulbizar", coordx = "580", coordy = "680"}
    };
------------------------------------------------------------------------------------------
-- DATA warden
------------------------------------------------------------------------------------------
...
wardenLocationsMap = { 
    warden1 = {mapHex = 0x41008130, texte = "Appell in der Feste Guruth", coordx = "630", coordy = "245"},
    warden2 = {mapHex = 0x41008132, texte = "Appell in Esteld\195\173n", coordx = "650", coordy = "320"},
    warden3 = {mapHex = 0x4101f084, texte = "Appell in Evendim", coordx = "510", coordy = "750"},
    warden4 = {mapHex = 0x4100812D, texte = "Appell in Bruchtal", coordx = "520", coordy = "420"},
    warden5 = {mapHex = 0x410e3f46, texte = "Appell in S\195\187ri-kyl\195\164", coordx = "540", coordy = "160"},
    warden6 = {mapHex = 0x410e871b, texte = "Appell in der Einundzwanzigsten Halle", coordx = "670", coordy = "180"},
    warden7 = {mapHex = 0x41100DF2, texte = "Appell in der Dunkelsenke", coordx = "100", coordy = "450"},
    warden8 = {mapHex = 0x411ad8a9, texte = "Appell in Harndirion", coordx = "460", coordy = "530"},
    warden9 = {mapHex = 0x41116EFE, texte = "Appell in Galtrev", coordx = "450", coordy = "360"},
    warden10 = {mapHex = 0x41123F09, texte = "Appell in Stangard", coordx = "440", coordy = "510"},
    warden11 = {mapHex = 0x410E8706, texte = "Appell in Caras Galadhon", coordx = "370", coordy = "520"},
    warden12 = {mapHex = 0x4100812f, texte = "Appell im Nebelgebirge", coordx = "760", coordy = "420"},
    warden13 = {mapHex = 0x41132E57, texte = "Appell in Schneegrenze", coordx = "425", coordy = "430"},
    warden14 = {mapHex = 0x411379FF, texte = "Appell in Forlach", coordx = "530", coordy = "700"},
    warden15 = {mapHex = 0x4113C321, texte = "Appell in Aldburg", coordx = "315", coordy = "410"},
    warden16 = {mapHex = 0x4113C323, texte = "Appell in Helms Klamm", coordx = "445", coordy = "430"},
    warden17 = {mapHex = 0x41154e05, texte = "Appell in Dol Amroth", coordx = "460", coordy = "340"},
    warden18 = {mapHex = 0x4115ee3c, texte = "Appell in Arnach", coordx = "535", coordy = "435"},
    warden19 = {mapHex = 0x411656ef, texte = "Appell in Minas Tirith", coordx = "860", coordy = "410"},
    warden20 = {mapHex = 0x4113C31F, texte = "Appell im Kriegslager", coordx = "460", coordy = "620"},
    warden21 = {mapHex = 0x4119389d, texte = "Appell im schlachtgezeichneten Minas Tirith", coordx = "860", coordy = "410"},
    warden22 = {mapHex = 0x411a42e7, texte = "Appell in Henneth Ann\195\187n", coordx = "600", coordy = "250"},
    warden23 = {mapHex = 0x411a42e5, texte = "Appell im schlachtgezeichneten Osgiliath", coordx = "650", coordy = "280"},
    warden24 = {mapHex = 0x411ad8a9, texte = "Appell im Lager des Heeres", coordx = "600", coordy = "250"},
    warden25 = {mapHex = 0x411ad8a9, texte = "Appell in Haerondir", coordx = "430", coordy = "540"},
    warden26 = {mapHex = 0x411b9591, texte = "Appell im Ud\195\187n-Br\195\160ckenkopf", coordx = "140", coordy = "150"},
    warden27 = {mapHex = 0x411c2de2, texte = "Appell in Thal", coordx = "750", coordy = "340"},
    warden28 = {mapHex = 0x411cd4b8, texte = "Musterung in J\195\161rnfast", coordx = "910", coordy = "260"},
    warden29 = {mapHex = 0x411c8da9, texte = "Musterung in Skarh\195\161ld", coordx = "450", coordy = "460"},
    warden30 = {mapHex = 0x4115B98B, texte = "Appell im Beorningerh\195\186s", coordx = "640", coordy = "400"},
    warden31 = {mapHex = 0x411da4a0, texte = "Appell in Hultv\195\173s", coordx = "670", coordy = "350"},
    warden32 = {mapHex = 0x411e9a41, texte = "Appell in Estolad L\195\162n", coordx = "610", coordy = "320"},
    warden33 = {mapHex = 0x411ee769, texte = "Appell in Liml\195\179k", coordx = "730", coordy = "560"},
    warden34 = {mapHex = 0x411fb86f, texte = "Appell in Ann\195\162k-khurfu", coordx = "720", coordy = "720"},
    warden35 = {mapHex = 0x4101f084, texte = "Appell am H\195\164ndlerkai", coordx = "720", coordy = "680"}, -- new from update U29
    warden36 = {mapHex = 0x41008132, texte = "Appell in Schragen", coordx = "240", coordy = "640"},
    warden37 = {mapHex = 0x4120d01b, texte = "Appell in Akr\195\162z-zahar", coordx = "580", coordy = "680"},
    warden38 = {mapHex = 0x4120d01b, texte = "Appell in Azanulbizar", coordx = "580", coordy = "680"}
    };
------------------------------------------------------------------------------------------
-- reputation travel
------------------------------------------------------------------------------------------
...
reputLocationsMap = { 
        reput1 = {mapHex = 0x4100812B, texte = "R\195\188ckkehr zu Thorins Tor", coordx = "450", coordy = "320"},
        reput2 = {mapHex =  0x41008136, texte = "R\195\188ckkehr nach Bree", coordx = "470", coordy = "500"},
        reput3 = {mapHex =  0x41008134, texte = "Kehrt zu Lalias Markt zur\195\188ck", coordx = "500", coordy = "370"},
        reput4 = {mapHex =  0x41008137, texte = "R\195\188ckkehr nach Michelbinge", coordx = "270", coordy = "525"},
        reput5 = {mapHex =  0x4100812D, texte = "R\195\188ckkehr nach Bruchtal", coordx = "520", coordy = "420"},
        reput6 = {mapHex =  0x41008130, texte = "R\195\188ckkehr zur Feste Guruth", coordx = "630", coordy = "245"},
        reput7 = {mapHex =  0x41100DF2, texte = "R\195\188ckkehr zum D\195\188sterwald", coordx = "100", coordy = "450"},
        reput8 = {mapHex =  0x411041a4, texte = "R\195\188ckkehr nach Enedwaith", coordx = "480", coordy = "440"},
        reput9 = {mapHex =  0x41116EFE, texte = "Kehrt nach Galtrev zur\195\188ck", coordx = "450", coordy = "360"},
        reput10 = {mapHex =  0x41123F09, texte = "Kehrt nach Stangard zur\195\188ck", coordx = "440", coordy = "510"},
        reput11 = {mapHex =  0x41132E57, texte = "Kehrt nach Schneegrenze zur\195\188ck", coordx = "425", coordy = "430"},
        reput12 = {mapHex =  0x411379FF, texte = "R\195\188ckkehr nach Forlach", coordx = "530", coordy = "700"},
        reput13 = {mapHex =  0x4113C321, texte = "Kehrt nach Aldburg zur\195\188ck", coordx = "315", coordy = "410"}, 
        reput14 = {mapHex =  0x4114BEAA, texte = "R\195\188ckkehr ins Geheimnistal", coordx = "0", coordy = "0"}, -- to check
        reput15 = {mapHex =  0x4113C323, texte = "Kehrt nach Helms Klamm zur\195\188ck", coordx = "445", coordy = "430"},
        reput16 = {mapHex =  0x41154e05, texte = "R\195\188ckkehr nach Dol Amroth", coordx = "460", coordy = "340"},
        reput17 = {mapHex =  0x4115ee3c, texte = "R\195\188ckkehr nach Arnach", coordx = "535", coordy = "435"},
        reput18 = {mapHex =  0x411656ef, texte = "Kehrt nach Minas Tirith zur\195\188ck", coordx = "860", coordy = "410"},
        reput19 = {mapHex =  0x4113C31F, texte = "Zur\195\188ck zum Kriegslager der Rohirrim", coordx = "460", coordy = "620"},
        reput20 = {mapHex =  0x4119389d, texte = "R\195\188ckkehr ins schlachtgezeichnete Minas Tirith", coordx = "860", coordy = "410"},
        reput21 = {mapHex =  0x411a42e7, texte = "R\195\188ckkehr nach Henneth Ann\195\187n", coordx = "600", coordy = "250"},
        reput22 = {mapHex =  0x411a42e5, texte = "R\195\188ckkehr ins schlachtgezeichnete Osgiliath", coordx = "650", coordy = "280"},
        reput23 = {mapHex =  0x411ad8a9, texte = "R\195\188ckkehr ins Lager des Heeres", coordx = "600", coordy = "250"},
        reput24 = {mapHex =  0x411ad8a9, texte = "R\195\188ckkehr nach Haerondir", coordx = "430", coordy = "540"},
        reput25 = {mapHex =  0x411b84d4, texte = "Zur\195\188ck zum Ud\195\187n-Br\195\188ckenkopf", coordx = "140", coordy = "150"},
        reput26 = {mapHex =  0x410e8707, texte = "Reise zum Hof von Lothl\195\179rien", coordx = "730", coordy = "540"},
        reput27 = {mapHex =  0x4100812B, texte = "Reise zur Halle des K\195\182nigs", coordx = "450", coordy = "320"},
        reput28 = {mapHex =  0x4100812B, texte = "Reise zur Halle unter dem Berg", coordx = "450", coordy = "320"},
        reput29 = {mapHex =  0x411a4436, texte = "Reise nach B\195\162r Thorenion", coordx = "0", coordy = "0"},
        reput30 = {mapHex =  0x411c2de2, texte = "R\195\188ckkehr nach Thal", coordx = "750", coordy = "340"},
        reput31 = {mapHex =  0x411cd4b8, texte = "R\195\188ckkehr nach J\195\161rnfast", coordx = "910", coordy = "260"},
        reput32 = {mapHex =  0x411c8da9, texte = "Kehrt nach Skarh\195\161ld zur\195\188ck", coordx = "450", coordy = "460"},
        reput33 = {mapHex =  0x4115B98B, texte = "Kehrt zum Beorningerh\195\186s zur\195\188ck", coordx = "640", coordy = "400"},
        reput34 = {mapHex =  0x411da4a0, texte = "Kehrt zum Hultv\195\173s zur\195\188ck", coordx = "670", coordy = "350"},
        reput35 = {mapHex =  0x411e9a41, texte = "Zur\195\188ck nach Estolad L\195\162n", coordx = "610", coordy = "320"},
        reput36 = {mapHex =  0x411ee769, texte = "R\195\188ckkehr nach Liml\195\179k", coordx = "730", coordy = "560"},
        reput37 = {mapHex =  0x411fb86f, texte = "R\195\188ckkehr nach Ann\195\162k-khurfu", coordx = "720", coordy = "720"},
        reput38 = {mapHex =  0x4101f084, texte = "Kehrt zum H\195\164ndlerkai zur\195\188ck", coordx = "720", coordy = "680"}, -- new from Update U29
        reput39 = {mapHex =  0x41008132, texte = "Kehrt nach Schragen zur\195\188ck", coordx = "240", coordy = "640"},
        reput40 = {mapHex =  0x4120d01b, texte = "R\195\188ckkehr nach Akr\195\162z-zahar", coordx = "580", coordy = "680"},
        reput41 = {mapHex =  0x4120d01b, texte = "R\195\188ckkehr nach Azanulbizar", coordx = "580", coordy = "680"}
        };
------------------------------------------------------------------------------------------
...
creepLocationsMap = {
        creep1 = {mapHex = 0x41008133, texte = "Etten\195\182den"}
        };
