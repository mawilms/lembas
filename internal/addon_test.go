...
func TestHasUpdate(t *testing.T) {
	tests := []struct {
		...
		{"remote is newer", Addon{LocalVersion: "v1.3.0"}, Addon{LocalVersion: "v1.3.1", RemoteVersion: "v1.3.1"}, true},
		{"remote is older", Addon{LocalVersion: "v1.3.1"}, Addon{LocalVersion: "v1.3.0"}, false},
		{"versions are equal", Addon{LocalVersion: "v1.3.0"}, Addon{LocalVersion: "v1.3.0"}, false},
	}
